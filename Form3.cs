    ...
    public partial class Form3 : Form
    {
        ...
        private void butCEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update customer set c_ID='" + this.txtCID.Text + "',c_Name='" + this.txtCName.Text + "',c_Tel='" + this.txtCTel.Text + "';";
        ...
        private void butCDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "delete from Customer where c_ID'" + this.txtCID.Text + "',c_Name'" + this.txtCName.Text + "',c_Tel'" + this.txtCTel.Text + "';";
