    ...
    public partial class Form4 : Form
    {
        ...
        private void butSEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update Size set s_ID='" + this.radioS.Checked + "','" + this.radioM.Checked + "','" + this.radioL.Checked + "','" + this.radioXL.Checked + "','" + this.radioXXL.Checked + "';"; 
        ...
        private void butSDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "delete from Size where s_ID'" + this.radioS.Checked + "','" + this.radioM.Checked + "','" + this.radioL.Checked + "','" + this.radioXL.Checked + "','" + this.radioXXL.Checked + "';";
