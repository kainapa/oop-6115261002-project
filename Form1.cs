    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "update ice_cream set p_ID='" + this.txtID.Text + "',p_Name ='" + this.txtName.Text + "'" + "' where p_Price'" + this.txtPrice.Text +  "';";
        ...
        private void butPDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "delete from ice_cream where p_ID'" + this.txtID.Text + "',p_Name'" + this.txtName.Text + "',p_Price'" + this.txtPrice.Text + "';";
